...
public class LootCondition {
    ...
    public static LootItemCondition matchEntity(Consumer<EntityPredicateBuilderJS> action) {
    ...
    public static LootItemCondition matchKiller(Consumer<EntityPredicateBuilderJS> action) {
        EntityPredicateBuilderJS builder = new EntityPredicateBuilderJS();
        action.accept(builder);
    ...
    public static LootItemCondition matchDirectKiller(Consumer<EntityPredicateBuilderJS> action) {
        EntityPredicateBuilderJS builder = new EntityPredicateBuilderJS();
        action.accept(builder);
    ...
    public static LootItemCondition matchPlayer(Consumer<EntityPredicateBuilderJS> action) {
        EntityPredicateBuilderJS builder = new EntityPredicateBuilderJS();
        action.accept(builder);
        return new MatchPlayer(builder.build());
    }

    public static LootItemCondition matchDamageSource(Consumer<DamageSourcePredicateBuilderJS> action) {
